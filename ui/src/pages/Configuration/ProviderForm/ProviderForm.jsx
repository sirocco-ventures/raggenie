                    ...
                    <div className="textarea-container" style={{ position: "relative", zIndex: "10000" }}>
                        <div style={{ display: "flex", alignItems: "center" }}>
                            <div style={{ flexGrow: "1" }}>
                                ...
                                <span key={`span-${row.table_id}`} className="span" style={{ pointerEvents: "none", height: "32px", overflow: "hidden", display: "block", whiteSpace: "nowrap", textOverflow: "ellipsis", maxWidth: "110ch" }}>{row.description}</span>
                            </div>
                                ...
                                <div className="child-textarea-container" style={{ width: "100%", height: "22px" }}>
                                    <div style={{ display: "flex", alignItems: "center" }}>
                                        <div style={{ flexGrow: 1 }}>
                                            ...
                                            <span className="span" style={{ pointerEvents: "none", height: "24px", overflow: "hidden", fontSize: "13px", display: "block", whiteSpace: "nowrap", textOverflow: "ellipsis", maxWidth: "110ch" }}>{tempTableDetails[row.data.table_id].columns[column.column_id].description != "" ? tempTableDetails[row.data.table_id].columns[column.column_id].description : column.description}</span>
                                        </div>
