...
const LineChart = ({title ="Line Chart", data = [], xAxis = "name", yAxis = "value", dataLength = 12, ...props})=>{



    const customXAxisLabel = ({ payload, x, y, width, height, value })=>{
        ...
        <>
            <div className={style.ChartContainer}>
                ...
                <ResponsiveContainer  width={450} height={183} >
                    <ReLineChart  data={data.slice(0, 12)}>
